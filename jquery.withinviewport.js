...
(function ($) {
    ...
    */
    jQuery.fn.withinviewport = function (settings) {
        var opts;
        var elems;
    ...
    jQuery.fn.withinviewporttop = function (settings) {
        var opts;
        var elems;
    ...
    jQuery.fn.withinviewportright = function (settings) {
        var opts;
        var elems;
    ...
    jQuery.fn.withinviewportbottom = function (settings) {
        var opts;
        var elems;
    ...
    jQuery.fn.withinviewportleft = function (settings) {
        var opts;
        var elems;
